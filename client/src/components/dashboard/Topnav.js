...
export default function Topnav() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (isCollapsed && collapseRef.current && !collapseRef.current.contains(event.target)) {
        ...
        <Container fluid>
          ...
          <div className="d-flex align-items-center justify-content-center gap-2">
            ...
            <Form.Check
              ...
              id="dark-mode-toggle"
              checked={isDark}
              onChange={() => toggleTheme()} // properly calls context function
              className="ms-3"
            />
      ...
      {isCollapsed && (
        ...
        >
          <Nav className="flex-column p-3">
            ...
            {/* Dark mode switch in offcanvas */}
            <Form.Check
              type="switch"
              id="dark-mode-toggle-offcanvas"
              checked={isDark}
