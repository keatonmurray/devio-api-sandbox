        ...
        <SectionHeader isDark={isDark} sectionTitle="Plugins" subSectionTitle="PayPal">
            <div className="d-flex align-items-center justify-content-start py-md-4 p-3 flex-wrap">
                ...
                <p className={`mb-0 ${isDark ? 'text-white' : 'text-muted'}`}>
                    Welcome to your PayPal API Configuration panel! The below configuration connects your application to the PayPal server. Your endpoint URL has been autogenerated for you. Once you click on save, your store is ready to accept payments.
                </p>
            </div>
            <form className="p-3">
                <div className="row">
